...
<head>
    ...
    <meta name="description" content="Szlaki w Kampinowskim parku narodowym"/>
    <meta name="keywords" content="szlaki, kampinowski park narodowy, polska"/>
    ...
    <link rel="stylesheet" href="lib/leaflet-routing-machine/dist/leaflet-routing-machine.css"/>

    <title>Wiktoria Kowalczyk - Szlaki</title>
</head>
<body>
<?php include("nav.php"); ?>
...
<script src="lib/leaflet-routing-machine/dist/leaflet-routing-machine.js"></script>
...
<script>
    $(document).ready(function () {
        ///---- MAPA
        var map = L.map('mymap', {center: [52.337, 20.556], zoom: 10});

        L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: '© OpenStreetMap contributors'
        }).addTo(map);

        // znaczniki wyznaczajace trase
        L.Routing.control({
            waypoints: [
                L.latLng(52.362771, 20.418663),
                L.latLng(52.337688, 20.415665)
            ],
